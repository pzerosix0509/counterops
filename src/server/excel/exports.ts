...
export async function buildEodExport(args: {
  ...
  const metrics: Array<[string, number | string]> = [
    ...
    ["Giá vốn hàng bán", formatVND(args.data.costOfGoods)],
    ["Lãi/Lỗ gộp", formatVND(args.data.grossProfit)],
    ["Phí kênh bán", formatVND(args.data.channelFees)],
    ["Lãi/Lỗ sau phí", formatVND(args.data.netProfit)],
    ["Biên lãi gộp", `${args.data.grossMarginPercent}%`],
