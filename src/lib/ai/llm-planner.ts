...
const INTENT_DESCRIPTIONS: Record<AiIntent, string> = {
  ...
  web_search: "Hỏi thông tin BÊN NGOÀI QUÁN: Giá thị trường (cà phê nhân, nông sản, giá vàng, tỷ giá, xăng dầu...), thời tiết, tin tức, xu hướng đồ uống/thị trường F&B, đối thủ cạnh tranh, công thức pha chế bên ngoài, tìm kiếm web",
  ...
  rfm: "Phân khúc giá trị RFM (Champions, Loyal, At Risk). Tách khỏi nhóm hành vi KMeans",
...
export async function planWithLlm(
  ...
  const prompt = [
    ...
    "Quy tắc:",
    "- Thông tin BÊN NGOÀI QUÁN: giá thị trường (cà phê nhân, nông sản, giá vàng, tỷ giá, xăng dầu...), thời tiết, tin tức, xu hướng đồ uống/thị trường F&B, đối thủ cạnh tranh, công thức/kiến thức pha chế bên ngoài, tìm kiếm web -> web_search (KHÔNG phải forecast/trend/metric_lookup).",
    "- 'dự đoán doanh thu' -> forecast. 'xu hướng doanh thu' -> trend.",
    "- Hỏi về số liệu NỘI BỘ QUÁN (doanh thu, lợi nhuận, đơn hàng, tồn kho, món trong menu của quán) -> metric_lookup/trend/comparison/product_ranking/inventory_risk...",
