...
const INTENT_DESCRIPTIONS: Record<AiIntent, string> = {
  ...
  web_search: "Tìm kiếm thông tin bên ngoài trên web (giá vàng, thời tiết, tin tức, crypto)",
  ...
  rfm: "Phân khúc giá trị RFM (Champions, Loyal, At Risk, Lost). Tách khỏi nhóm hành vi KMeans",
  sentiment: "Cảm xúc phản hồi khách, feedback, review (tách khỏi điểm sao)",
  segmentation: "Nhóm hành vi khách, phân cụm KMeans (tách khỏi RFM value segment)",
